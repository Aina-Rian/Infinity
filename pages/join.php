               ...
               <div class="row">
				 ...
				 <div class="col-lg-4 col-md-4 col-sm-12">
				    <div class="contact_form log" id="login"  >
					    <form method="post"  id="loginForm" name="form" class="form" action="../php/cplogin.php" >
						   <fieldset>
                                ...
                                <div class="full field form-group">
                                    <input type="text" class="form-contrl" placeholder="&nbsp;" name="email" id="email"/>
                               ...
                               <div class="full forget">
                                <div class="center"><a href="resetp.html">Forgot Password?</a></div>
                                </div>
							   <div class="full field">
							      <div class="center"><button type="submit" name="login" id="login">Login</button></div>
							   </div>
                               <div class="full signup">
                                <div class="center">Not a member yet? &nbsp;<a href="Sign.html"> Sign up now</a></div>
                             </div>
						   </fieldset>
						</form>
					</div>
