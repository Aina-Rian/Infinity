               ...
               <div class="row">
				 ...
				 <div class="col-lg-4 col-md-4 col-sm-12">
				    <div class="contact_form log" id="login">
					    <form method="post" action="../php/cplogin.php" id="form" name="form">
						   <fieldset>
                                ...
                                <div class="full field form-group">
                                    <input type="text" class="form-contrl" placeholder="&nbsp;" name="email" id="email" value="<?= $email; ?>"/>
                               ...
                               <div class="full signup">
                                <div class="center">Not a member yet? &nbsp;<a href="../pages/Sign.html"> Sign up now</a></div>
                             </div>
						   </fieldset>
						</form>
					</div>
