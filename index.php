            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="pages/courses.html">Courses</a></li>
                        <li><a class="nav-link" href="pages/join.html">Join us</a></li>
                                ...
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        ...
                                        <div class="full center">
										    <a class="contact_bt" href="pages/courses.html">Start a Course</a>
										</div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
						...
						<div class="full">
						   <a class="hvr-radial-out button-theme" href="pages/about.html">About more</a>
						</div>
                    </div>
                </div>
				<div class="col-md-6">
